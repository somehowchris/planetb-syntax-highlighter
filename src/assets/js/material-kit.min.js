    ...
    total.forEach(function (o, e) {
      ...
      if (i) {
        ...
        if (o.classList.contains("flex-column")) {
          for (var r = 1; r <= e.indexOf(i); r++)
            t += o.querySelector("li:nth-child(" + r + ")").offsetHeight;
          (l.style.transform = "translate3d(0px," + t + "px, 0px)"),
            (l.style.width =
              o.querySelector("li:nth-child(" + n + ")").offsetWidth + "px"),
            (l.style.height = o.querySelector(
              "li:nth-child(" + r + ")"
            ).offsetHeight);
        } else {
          for (r = 1; r <= e.indexOf(i); r++)
            t += o.querySelector("li:nth-child(" + r + ")").offsetWidth;
          (l.style.transform = "translate3d(" + t + "px, 0px, 0px)"),
            (l.style.width =
              o.querySelector("li:nth-child(" + n + ")").offsetWidth + "px");
        }
      }
